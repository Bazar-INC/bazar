      ...
      <div className="bg-[#1d1d1d] fixed bottom-0 w-full sm:hidden shadow-[0_0_16px_rgba(0,0,0,0.5)]">
         <div className="flex justify-center gap-x-8 py-4">
            <div className="flex flex-col items-center">
               {icons.Home}
               <span className="text-white font-bold text-[11px] mt-1">Головна</span>
            </div>
            <div className="flex flex-col items-center">
               {icons.Catalog}
               <span className="text-white font-bold text-[11px] mt-1">Каталог</span>
            </div>
            <div className="flex flex-col items-center">
               {icons.Search}
               <span className="text-white font-bold text-[11px] mt-1">Пошук</span>
            </div>
            <div className="flex flex-col items-center">
               {icons.Cart}
               <span className="text-white font-bold text-[11px] mt-1">Корзина</span>
            </div>
            <div className="flex flex-col items-center">
               {icons.Other}
               <span className="text-white font-bold text-[11px] mt-1">Інше</span>
            </div>
         </div>
      </div>
   );
