      ...
      <div className="w-full py-5">
         ...
         <div className="mt-[30px] space-y-3">
            {products.get.map((product, index) => (
               <div key={index} className="flex items-center justify-between bg-white rounded-lg py-3 px-6">
                  <div className="flex">
                     <img className="w-12 h-12 object-contain" src={product.images[0]} />
                     <span className="text-[15px] font-[Gotham] text-black font-bold ml-5 w-[200px] md:w-[527px] h-min my-auto">{product.name}</span>
                  </div>

                  <div className="flex">
                     <div className="hover:scale-105">
                        <svg className="cursor-pointer mr-[15px] h-5 w-5" width="25" height="25" viewBox="0 0 25 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                     ...
                     <div className="hover:scale-105" onClick={() => deleteCategory(product.id)}>
                        <svg className="h-5 w-5 cursor-pointer" width="25" height="25" viewBox="0 0 25 25" fill="none" xmlns="http://www.w3.org/2000/svg">
