         ...
         <div className="flex flex-col mt-[30px]">
            <div className="flex flex-row">
               ...
               <div className="ml-[40px] w-[150px] flex flex-col">
                  <Typography.Heading className=" text-[#949494]">Ціна</Typography.Heading>
                  <Layout.Input
                     type="text"
                     hint="Ціна"
                     className="h-[50px] rounded-lg mt-[15px]"
            ...
            <div className="mt-[30px] flex flex-col">
               <Typography.Heading className=" text-[#949494]">Фото</Typography.Heading>
            ...
            <div className="mt-[30px] flex flex-col">
               <Typography.Heading className=" text-[#949494]">Опис</Typography.Heading>
               <Layout.Input
                  type="text"
                  hint="Опис"
            ...
            <div className="flex flex-col md:flex-row">
               <div className=" md:w-full mt-[30px] md:ml-[50px] flex flex-col">
                  <Typography.Heading className=" text-[#949494]">Категорія</Typography.Heading>
               ...
               <div className="mt-[30px] md:w-full flex flex-col md:order-first md:mr-[50px]">
                  ...
                  <div className="h-[50px] mt-[20px] flex">
                     ...
                     <Typography.Heading className="h-min my-auto ml-[20px] text-[#949494]">Додати фільтр</Typography.Heading>
                  </div>
               </div>
            </div>
