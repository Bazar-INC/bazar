      ...
      <div className="w-full py-[20px]">
         ...
         <div className="mt-[30px]">
            {reviewItems.map((item, index) => (
               <div key={index} className="flex flex-col bg-white rounded-lg pl-[20px] pt-[24px] pb-[24px] pr-[20px] mb-[10px] md:mb-[30px]">
                  <div className="flex items-center justify-between">
                     <div className="flex">
                        <div className="w-[40px] h-[40px] mr-[15px]">
                           {item.product.icon}
                        </div>
                        <Typography.Heading className="h-min my-auto">{item.product.label}</Typography.Heading>
                     </div>
                  ...
                  <div className="flex flex-col mt-[24px]">
                     <div className="flex">
                        <div className="w-[40px] h-[40px] mr-[15px] md:ml-[50px]">
                           {item.review.avatar}
                        </div>
                        <Typography.Heading className="h-min my-auto">{item.review.name}</Typography.Heading>
                     </div>

                     <div className="ml-[55px] md:ml-[105px]">
