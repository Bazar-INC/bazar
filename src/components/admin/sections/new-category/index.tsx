      ...
      <div className="w-full py-[20px] flex flex-col">
         ...
         <div className="flex flex-col mt-[30px]">
            ...
            <div className="flex flex-row justify-center">
               ...
               <div className="h-[126px] w-[126px] bg-white rounded-lg  mt-auto flex flex-col justify-center">
                  <svg className="mx-auto" width="64" height="64" viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <span className="text-[#949494] font-[Gotham] font-bold text-[20px] mx-auto">Іконка</span>
               </div>
            </div>
