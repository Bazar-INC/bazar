         ...
         <div className="mt-[30px]">
            {categories.get.map((category, index) => (
               <div key={index} className="flex items-center justify-between bg-white rounded-lg  h-[70px] pl-[20px] pt-[10px] pb-[10px] pr-[10px] mb-[10px]">
                  <div className="flex">
                     <span className="text-[15px] font-[Gotham] text-black font-bold ml-5 w-[200px] md:w-[527px] h-min my-auto">{category.name}</span>
                  </div>
                  ...
                  <div className="flex">
                     ...
                     <svg onClick={() => deleteCategory(category.id)} className="cursor-pointer" width="25" height="25" viewBox="0 0 25 25" fill="none" xmlns="http://www.w3.org/2000/svg">
